...
public class Configure {
    ...
    private static String key = "12345678as12345678as12345678asas";

    //微信分配的公众号ID（开通公众号之后可以获取到）
    private static String appID = "wx61afb7c6dddd0806";
    //roger测试号
    // private static String appID = "wxe77e6cada6b7344f";

    private static String appSecret = "b1def0804063b267dc2650806d6409af";
    //roger测试号
    // private static String appSecret = "fe1b97dd7e20110a7070e055fb8a3f8e";

    private static String token = "roger";
