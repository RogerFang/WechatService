...
<head>
    ...
    <%--<title>发起活动</title>--%>
    <link rel="stylesheet" href="${ctx}/css/launchOfflineActivity.css" type="text/css">
</head>
<body>
<div id="wrapper">
    <form action="${ctx}/eventinfo/releaseOffline" method="post" enctype="multipart/form-data">
        ...
        <div id="content">
            <div class="weui_cells weui_cells_form">
                ...
                <div class="weui_cell">
                    <div class="weui_cell_hd"><label class="weui_label">活动地点：</label></div>
                    <div class="weui_cell_bd weui_cell_primary">
                        <input class="weui_input" type="text" placeholder="选择活动地点" id="location" name="location"/>
                    </div>
                </div>
                <div class="weui_cell">
                    <div class="weui_cell_hd"><label class="weui_label">具体地点：</label></div>
                    <div class="weui_cell_bd weui_cell_primary">
                        <input class="weui_input" type="text" placeholder="选择活动具体地点" name="eventPlace"/>
                    </div>
                </div>
...
<script type="text/javascript" src="${ctx}/js/launchOfflineActivity.js" charset="gbk"></script>
</body>
</html>
